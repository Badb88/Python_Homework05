...
while candy > 0:
    if r == 1:
        ...
        if candy == 0:
            break
        p2 = int(input("Ходит игрок № 2. Возьмите количество конфет, но не более 28: "))
        while p2 > candy:
            p2 = int(input("Ошибка! Возьмите количество конфет не более чем осталось: "))
            print()
        while int(p2) <= 0 or int(p2) > 28:
            p2 = int(input("Вы можете взять от 1 до 28 конфет: "))
            print()
            while p2 > candy:
                p2 = int(input("Ошибка! Возьмите количество конфет не более чем осталось: "))
                print()
